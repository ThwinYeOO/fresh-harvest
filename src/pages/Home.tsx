      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 lg:space-y-8 animate-slide-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald/10 rounded-full">
              <span className="w-2 h-2 bg-emerald rounded-full animate-pulse" />
              <span className="text-sm font-medium text-emerald">100% Organic & Fresh</span>
            </div>

            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-charcoal leading-tight">
              Fresh From
              <br />
              <span className="text-emerald">The Farm</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                size="lg"
                className="bg-emerald hover:bg-emerald/90 text-white h-14 px-8 text-lg"
              >
                Shop Now
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-emerald text-emerald hover:bg-emerald/10 h-14 px-8 text-lg"
              >
                Explore Products
              </Button>
            </div>
            ...
            <div className="flex items-center gap-8 pt-4">
              <div>
                <p className="font-display text-3xl font-bold text-emerald">50K+</p>
                <p className="text-sm text-gray">Happy Customers</p>
              </div>
              <div className="w-px h-12 bg-gray-200" />
              <div>
                <p className="font-display text-3xl font-bold text-emerald">200+</p>
                <p className="text-sm text-gray">Local Farms</p>
              </div>
              <div className="w-px h-12 bg-gray-200" />
              <div>
                <p className="font-display text-3xl font-bold text-emerald">100%</p>
          ...
          >
            <div className="relative">
              ...
              {/* Price Tag */}
              <div className="absolute -top-4 -right-4 bg-emerald text-white rounded-2xl shadow-lg p-4 animate-float">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="font-display text-3xl lg:text-4xl font-bold text-charcoal mb-4">
            Explore by <span className="text-emerald">Taste</span>
          </h2>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-12">
          <div>
            <h2 className="font-display text-3xl lg:text-4xl font-bold text-charcoal mb-2">
              Fresh <span className="text-emerald">Picks</span>
            </h2>
  ...
  return (
    <section className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="font-display text-3xl lg:text-4xl font-bold text-charcoal mb-4">
            What People <span className="text-emerald">Say</span>
          </h2>
            <p className="text-gray max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              ...
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <Quote className="w-10 h-10 text-emerald/20 mb-4" />
    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-12">
          <div>
            <h2 className="font-display text-3xl lg:text-4xl font-bold text-charcoal mb-2">
              Fresh From The <span className="text-emerald">Blog</span>
            </h2>
            <p className="text-gray">
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-xs font-medium text-emerald bg-emerald/10 px-2 py-1 rounded-full">
                    {post.category}
                  </span>
                  <span className="text-xs text-gray">{post.readTime}</span>
                </div>
                <h3 className="font-display text-lg font-semibold text-charcoal group-hover:text-emerald transition-colors line-clamp-2 mb-2">
                  {post.title}
                </h3>
  ...
  return (
    <section className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="font-display text-3xl lg:text-4xl font-bold text-charcoal mb-4">
            Follow Us on <span className="text-emerald">Instagram</span>
          </h2>
          <p className="font-accent text-2xl text-golden">@HtooHtoo</p>
        </div>
          ...
          {instagramImages.map((image, index) => (
            ...
            >
              <img
                ...
                className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-emerald/0 group-hover:bg-emerald/40 transition-colors flex items-center justify-center">
